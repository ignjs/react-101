...
export const msalConfig = {
    auth: {
        clientId: "{{node_ci}}", // This is the ONLY mandatory field that you need to supply.
        authority: "https://login.microsoftonline.com/{{node_tenant}}", // Defaults to "https://login.microsoftonline.com/common"
